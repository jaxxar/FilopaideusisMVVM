    ...
    class Callback @Inject constructor(
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                ...
                sections.insert(SectionsData(1, 1, 1000, "Μαθηματικά", "Ενότητα 1", true))
                sections.insert(SectionsData(2, 1, 1001, "Γλώσσα", null, true))
                sections.insert(
                    SectionsData(3, 1, 1002, "ΑΝΘΟΛΟΓΙΟ ΛΟΓΟΤΕΧΝΙΚΩΝ ΚΕΙΜΕΝΩΝ", null, true)
                )
                sections.insert(SectionsData(4, 1, 1003, "ΜΟΥΣΙΚΗ", null, true))
                sections.insert(SectionsData(5, 1, 1004, "ΜΕΛΕΤΗ ΠΕΡΙΒΑΛΛΟΝΤΟΣ", null, true))
                sections.insert(SectionsData(6, 2, 1005, "Γλώσσα", null, true))

                sections.insert(SectionsData(7, 6, 1100, "Ιστορία", null, true))
