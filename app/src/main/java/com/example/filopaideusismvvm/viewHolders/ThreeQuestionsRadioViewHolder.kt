...
class ThreeQuestionsRadioViewHolder(private val binding: DesignThreeQuestionsBinding) : BaseQuestionViewHolder<QuestionData, QuestionViewModel, QuestionCallback>(binding.root) {
